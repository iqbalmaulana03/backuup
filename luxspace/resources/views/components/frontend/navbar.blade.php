        ...
        <div class="w-auto">
          <ul class="items-center flex">
            <li class="ml-6 block md:hidden">
              <button
                id="menu-toggler"
                class="relative flex z-50 items-center justify-center w-8 h-8 {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} focus:outline-none"
              >
                <svg
                  class="fill-current"
                  width="18"
            ...
            <li class="ml-6">
              <a
                id="header-cart"
                class="flex items-center justify-center w-8 h-8 {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}"
                href="{{ route('cart') }}"
              >
                <svg
                  class="fill-current"
